...
# 일반적으로 'NanumGothic' 또는 'Malgun Gothic'이 사용됩니다.
try:
    # 먼저 'NanumGothic' 폰트를 찾습니다.
    font_name = fm.FontProperties(fname=fm.findSystemFonts(fontpaths=None, fontext='ttf')[-1]).get_name()
    ...
    st.warning(f"한글 폰트를 찾지 못했습니다. 차트에 글자가 깨져 보일 수 있습니다. 오류: {e}")
