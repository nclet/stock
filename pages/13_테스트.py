...
st.markdown("""
이 모델은 **기술적 지표**, **뉴스 감성**, **시장 심리(Fear & Greed Index)**, 그리고 **구글 트렌드** 데이터를 결합하여
주요 암호화폐의 가격을 예측합니다.
""")
